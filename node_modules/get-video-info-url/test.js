...
test(`It should also work with a url`, async (t) => {
  var info = await getVideoInfo('http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4')

  t.is(info.streams[0].codec_name, 'aac')
  t.is(info.format.duration, '60.095000')
})
